...
class Client(Socket):
    ...
    * settimeout(timeout): time to wait for the client to respond
    ...
    :param int buffer_size: number of bytes of the incomming data.
    ...
    * ...
    ...
    def read_data(self, size):
        ...
        :return: A data cocatenation of all packages read from the 
         input buffer.
        """
        bytes = 0
        packages = []
    ...
    def read_register(self, regkey):
        ...
        :return: the containt of the register
        :rtype: int or list
        """
